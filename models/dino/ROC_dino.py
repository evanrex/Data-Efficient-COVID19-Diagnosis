...
def eval_models(baseline,dino1,dino2,dino3, dataloaders):
    ...
    for inputs, labels in dataloaders[phase]:
        ...
        with torch.set_grad_enabled(False):
            ...
            y_score__baseline = probabilities_baseline.detach().cpu().numpy(force=True)

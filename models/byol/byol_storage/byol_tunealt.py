...
PRETRAINED_PATH = ROOT+ "/byol/saving_dir_alt/checkpoint.pt"

MODEL_PATH = ROOT + "/byol/saving_dir_alt/byol_model.pt"
...
def main():
    ...
    '''
    model_ft, input_size = load_saved_model(PATH=PRETRAINED_PATH)
